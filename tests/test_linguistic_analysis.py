def test_linguistic_analysis_response_code_valid_input(client, auth_headers):
...
def test_linguistic_analysis_response_has_correct_structure(client, auth_headers):
...
def test_linguistic_analysis_missing_text_field_returns_422(client, auth_headers):
...
def test_linguistic_analysis_null_text_returns_422(client, auth_headers):
...
def test_linguistic_analysis_wrong_method_returns_405(client):
    """GET request to POST endpoint should return 405 method not allowed."""
    response = client.get("/linguistic-analysis")
    assert response.status_code == 405

def test_linguistic_analysis_correct_values_known_sentence(client, auth_headers):
...
def test_linguistic_analysis_empty_text(client, auth_headers):
...
def test_linguistic_analysis_single_word_text(client, auth_headers):
...
def test_linguistic_analysis_nonsense_text(client, auth_headers):
...
def test_unsupported_language_returns_400(client, auth_headers):
...
def test_auto_detect_unsupported_language_returns_400(client, auth_headers):
...
def test_explicitly_specified_spanish_language_returns_language_code_and_200(client, auth_headers):
...
def test_auto_detect_spanish_language_returns_language_code_and_200(client, auth_headers):
...
def test_auto_detect_english_language_returns_language_code_and_200(client, auth_headers):
...
def test_empty_string_language_triggers_auto_detection(client, auth_headers):
...
def test_explicitly_specified_english_language_returns_language_code_and_200(client, auth_headers):
...
def test_empty_text_returns_language_none(client, auth_headers):
